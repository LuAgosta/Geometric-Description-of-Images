...
public:
	...
	FixedImage(PatchSize size);
	FixedImage(PatchSize size, uint number_of_channels);
	FixedImage(PatchSize size, T default_value);
	FixedImage(PatchSize size, uint number_of_channels, T default_value);
	...
	void draw_rect(uint x, uint y, uint Width, uint Height, T value) ;
	void draw_rect(uint x, uint y, uint Width, uint Height, uint channel, T value) ; 
...
public:
	...
	Image(PatchSize size);
	Image(PatchSize size, uint number_of_channels);
	Image(PatchSize size, T default_value);
	Image(PatchSize size, uint number_of_channels, T default_value);
