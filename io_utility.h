...
public:
	...
	// Reading and writing for a flow field (.flo) using IIO.
	static Image<float> read_flow_image(const string &name);
	static void write_flow_image(const string &name, FixedImage<float> image);
	...
	//TODO:
	// static Image<float> rgb_to_census(FixedImage<float> image);
		////////////ROBERTO////////////////////
	static void write_vectorial_image(const string &name, FixedImage<float> image);
	static void write_vectorial_image(const string &name, FixedImage<uint8_t> image);
	////////////ROBERTO////////////////////
